    ...
    return (
        <>
            ...
            <section className="message-section">
                ...
                <p>
                    Nosso grande dia está chegando!! Fizemos este site para dar sugestões de presentes. Fiquem a vontade, essa lista é apenas para sugestão, podem presentear com algo que não esteja aqui. Ao escolher o presente nesse site outra pessoa não poderá escolher-lo.
                </p>
                <p>
                    Aguardamos vocês no nosso grande dia! E para que seja ainda mais especial, contamos com a   sua presença, afinal, nada melhor que compartilhar os melhores momentos de nossas vidas na    companhia de familiares e amigos tão queridos.
                </p>
            </section>
